set title "Region C RLG Overflow Plans: Cross Region Shedding"
...
if (system ("awk -F ',' '{sum += $10 + $11 + $12 + $13} END {print sum}' service_AppCoordinates_\{com.bbn__webservice__1\}-rlg_overflow_plans.csv") > 0) { \
set output "4-rlg-overflow-c.eps"; \
plot for [i=10:13] 'service_AppCoordinates_{com.bbn__webservice__1}-rlg_overflow_plans.csv' using 1:i dt i lt i lw 3 \
} else { \
system ("echo no") \
}
