set title "Client Dispatch Table Region C: Lo-Fi Sim Outputs"
...
set output "5-1-tablec-dispatch-all.png"
...
plot for [i=2:5] "clientPoolC-requests_to_regions.csv" using 1:i title "From C to ".columnhead(i) lt (i-2) lc 'green'
