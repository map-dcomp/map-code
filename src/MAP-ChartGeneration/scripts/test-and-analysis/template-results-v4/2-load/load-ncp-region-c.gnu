set title "NCP Load Plot Region C - Container Count"
...
if (system ("awk -F ',' '{sum += $12 + $13 + $14 + $15 + $16} END {print sum}' nodes-TASK_CONTAINERS.csv") > 0) { \
set output "2c-load-nodes-c-TASK_CONTAINERS.eps"; \
plot for [i=12:16] 'nodes-TASK_CONTAINERS.csv' using 1:i dt i lt i \
} else { \
system ("echo no") \
}
